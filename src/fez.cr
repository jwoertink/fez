...
OptionParser.parse! do |parser|
  ...
  parser.on("-t ENGINE", "--template=ENGINE", "Change the view template engine. Options are 'slang' or 'ecr'. Default: slang") { |engine| Fez::DefaultOptions.template_engine = engine }
